	...
	for(POS p=0;p<32;p++){
		...
		if(c!=-1){
			switch(GetLevel(B.fin[p])){
				case 0: chess_power=20000;break;
				case 1: chess_power=10000;break;
				case 2: chess_power=3300;break;
				case 3: chess_power=1000;break;
				case 4: chess_power=300;break;
				case 5: chess_power=3000;break;
				case 6:	chess_power=140;break;
			}
