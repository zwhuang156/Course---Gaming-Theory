	...
	for(POS p=0;p<32;p++){
		...
		if(c!=-1){
			switch(GetLevel(B.fin[p])){
				case 0: chess_power=1000;
				case 1: chess_power=500;
				case 2: chess_power=180;
				case 3: chess_power=60;
				case 4: chess_power=20;
				case 5: chess_power=150;
				case 6:	chess_power=5;	
			}
...
//std::cout<<"best move: "<<BestMove.st<<" "<<BestMove.ed<<"\n";
	if(NegaScout(B,0,15,-INF,INF,do_hash,0)>Eval(B))return BestMove;
